...
$(function(){
  $("#login_nav").popover({
    placement: 'bottom',
    html: true,
    content : '<center><button type="button" class="btn btn-danger btn-sm" id="admReg" style=" background-color: #3a906d;" >Administrador</button><br><br> <button type="button" id="egresadoReg" style=" background-color: #3a906d;" class="btn btn-success btn-sm">Egresado</button></center>'
  })
  $('html').click(function() {
    $('#close').popover('hide');
  });
